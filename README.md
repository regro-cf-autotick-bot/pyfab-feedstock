...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyfab-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12823&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyfab-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyfab` can be installed with:

```
conda install pyfab
```

It is possible to list all of the versions of `pyfab` available on your platform with:
